...
namespace SimElation.SimHubIntegration.SliF1Plugin
{
	...
	{
		/// <summary><see cref="SliF1Plugin"/> accessor.</summary>
		public SliF1Plugin Plugin { get; }
		...
		private static String MakeSegmentDisplayActionName(String baseName)
		{
			...
			return String.Format("{0}.{1}", typeof(SliF1Plugin).Name, baseName);
		}

		/// <summary>Constructor.</summary>
		/// <param name="plugin"></param>
		public SettingsControl(SliF1Plugin plugin)
		{
			DataContext = this;
			Plugin = plugin;
		...
		private String[] MakeSegmentDisplayNameList(SliF1.SegmentDisplayPosition segmentDisplayPosition)
		{
		...
		private void OnHelpClick(object sender, System.Windows.RoutedEventArgs e)
		{
			...
			if (index != -1)
			{
				...
				branch = String.Format("%40simelation/simhub-slif1-plugin%40{0}", tagVersion);
			}

			String url = String.Format("{0}/{1}/packages/slif1-plugin/README.md", rootUrl, branch);
		...
		{
			Settings.SliF1Settings.BrightnessRotarySwitchIndex =
				await DetectOrForgetRotary(Settings.SliF1Settings.BrightnessRotarySwitchIndex, "brightness level");
		}
		...
		private void OnSliF1Click(object sender, System.Windows.Input.MouseButtonEventArgs e)
		{
